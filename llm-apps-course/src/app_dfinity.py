"""A Simple chatbot that uses the LangChain and Gradio UI to answer questions about DFINITY documentation."""
import os
...
class Chat:
    ...
    def __call__(
        ...
        """Answer a question about DFINITY documentation using the LangChain QA chain and vector store retriever.
        Args:
...
with gr.Blocks() as demo:
    gr.HTML(
        ...
        Hi, I'm a DFINITY documentaion Q&A bot. Type in (1) your OpenAI API key, (2) questions/issues you have related to DFINITY Web Development and then press enter.<br>
